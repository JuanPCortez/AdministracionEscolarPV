...
from Formularios import Administrador
...
class VentanaAdministrador(QMainWindow):
    def __init__(self):
        ...
        # Habilitar fondo con estilo CSS
        page_avisos.setAttribute(Qt.WA_StyledBackground, True)
        contenedor_scroll.setAttribute(Qt.WA_StyledBackground, True)
    ...
    def agregar_anuncio(self):
        widget = Administrador.AnuncioAgregar()
    ...
    def editar_anuncio(self):
        widget = Administrador.AnuncioEditar()
    ...
    def borrar_anuncio(self):
        widget = Administrador.AnuncioBorrar()
    ...
    def agregar_usuario(self):
        widget = Administrador.UsuarioAgregar()
    ...
    def buscar_usuario(self):
        widget = Administrador.UsuarioBuscar()
        widget.cancelarSignal.connect(self.mostrar_avisos)
    ...
    def editar_usuario(self):
        widget = Administrador.UsuarioEditar()
        widget.editarSignal.connect(self.mostrar_avisos)
        widget.cancelarSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def borrar_usuario(self):
        widget = Administrador.UsuarioEliminar()
        widget.borrarSignal.connect(self.mostrar_avisos)
        widget.cancelarSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def agregar_materia(self):
        widget = Administrador.MateriaAgregar()
        widget.agregarSignal.connect(self.mostrar_avisos)
        widget.cancelarSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def buscar_materia(self):
        widget = Administrador.BuscarMateria()
        widget.salirSignal.connect(self.mostrar_avisos)
        widget.cancelarSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def editar_materia(self):
        widget = Administrador.EditarMateria()
        widget.editarSignal.connect(self.mostrar_avisos)
        widget.cancelarSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def borrar_materia(self):
        widget = Administrador.BorrarMateria()
        widget.borrarSignal.connect(self.mostrar_avisos)
        widget.cancelarSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def agregar_reporte(self):
        widget = Administrador.ReporteAgregar()
        widget.subirSignal.connect(self.mostrar_avisos)
        widget.cancelarSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def borrar_reporte(self):
        widget = Administrador.ReporteBorrar()
        widget.borrarSignal.connect(self.mostrar_avisos)
        widget.cancelarSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def buscar_reporte(self):
       widget=Administrador.ReporteBuscar()
       widget.cancelarSignal.connect(self.mostrar_avisos)
       widget.salirSignal.connect(self.mostrar_avisos)
       self.__right_panel.addWidget(widget)
       self.__right_panel.setCurrentWidget(widget)
    ...
    def mostrar_reporte(self):
        widget=Administrador.ReporteMostrar()
        widget.cancelarSignal.connect(self.mostrar_avisos)
        widget.salirSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def asignar_materia_profesor(self):
        widget = Administrador.AsignarMateriaProfesor()
        widget.cancelarSignal.connect(self.mostrar_avisos)
        widget.salirSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def asignar_materia_alumno(self):
        widget=Administrador.AsignarGrupoAlumno()
        widget.cancelarSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def agregar_horario(self):
        widget = Administrador.HorarioAgregar()
        widget.agregarSignal.connect(self.mostrar_avisos)
        widget.cancelarSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def consultar_horario(self):
        widget = Administrador.HorarioConsultar()
        widget.salirSignal.connect(self.mostrar_avisos)
        widget.cancelarSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def editar_horario(self):
        widget = Administrador.HorarioEditar()
        widget.editarSignal.connect(self.mostrar_avisos)
        widget.cancelarSignal.connect(self.mostrar_avisos)
        self.__right_panel.addWidget(widget)
        self.__right_panel.setCurrentWidget(widget)
    ...
    def borrar_horario(self):
        widget = Administrador.HorarioEliminar()
